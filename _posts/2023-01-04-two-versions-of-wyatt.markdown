...
<i>The below is somewhat wrong. It is not that Wyatt offsets the ceasura as here claimed, but that he often freely adds or subtracts syllables around it and elsewhere, which appears to produce the effect of offsetting it. I have written on this in a <a href="/TheatrumMundi/jekyll/update/2024/04/23/note-on-wyatts-prosody.html">Note on Wyatt's Prosody</a>, which represents my current views. Consider the line</i> Í have séne theim| géntill táme and méke.<i> Scanned so, it makes a line of trochees minus one syllable. This line of trochees is produced simply by dropping the first unstressed syllable which would begin the first iamb if the line had instead been iambic. I believe this dropped syllable is accounted for by holding onto the first stressed syllable </i>I,<i> following a form of accounting similar to what one finds in quantitive verse, where, in certain conditions, shorts may be read as, and so count as, long, or where a long can stand as two shorts. I believe Wyatt often engages in a similar kind of substitution where he will count a foot of one syllable as "complete" if, in reading it, the stressed syllable is held long, or otherwise count two short syllables as a single one if they read especially fast. Of course, that Wyatt is holding onto the first syllable in the above line is a supposition on my part, but I base it on the my belief that this is how the line reads best. It might be better, taking a more general view, to not only speak about stressed and unstressed or long and short, but also of "strong" and "weak" syllables. In the above line, I would count as a strong syllable, being a long stressed syllable substituting in a foot for an combination of a weak unstressed and stressed syllable, which in convention, would otherwise form an iambic foot. Tottel, as you can see in the below reproduced emendation, does not know how to read a line of Wyatt, and so feels the need to introduce an additional syllable at the beginning ("once"). The distinction of Wyatt's verse, as I have written elsewhere, is the use of length to subordinate the counting of feet to rhythm and the caesura.</i>
